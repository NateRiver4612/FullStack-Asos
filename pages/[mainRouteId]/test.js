  ...
  return (
    <div class="flex space-x-2">
      <div>
        ...
        <div
          class="offcanvas offcanvas-start fixed bottom-0 flex flex-col max-w-[315px] bg-white invisible bg-clip-padding shadow-sm outline-none transition duration-300 ease-in-out text-gray-700 top-0 left-0 border-none w-96"
          tabindex="-1"
          id="offcanvasExample"
