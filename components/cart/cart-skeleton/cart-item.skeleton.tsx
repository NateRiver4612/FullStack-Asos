  ...
  return (
    <div className="flex animate-pulse border-b-[1px] gap-5 pb-5 border-gray-200">
      ...
      <div className=" w-[75%] flex flex-col gap-2">
        ...
        <div className="w-[30%] rounded-md h-[20px] bg-gray-200"></div>
        <div className="w-[20%] rounded-md h-[20px] bg-gray-200"></div>
        <div className="w-[40%] rounded-md h-[20px] bg-gray-200"></div>
        <div className="w-[35%] rounded-md mt-4 h-[35px] bg-gray-200"></div>
      </div>
    </div>
  );
};
